...
public class BehaviorAdapter extends EObjectAdapter<Behavior> implements statemachines.almostuml.Behavior {
  ...
  public EClass eClass() {
    return statemachines.almostuml.AlmostumlPackage.eINSTANCE.getBehavior();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case statemachines.almostuml.AlmostumlPackage.BEHAVIOR__NAME:
    		return getName();
    }
