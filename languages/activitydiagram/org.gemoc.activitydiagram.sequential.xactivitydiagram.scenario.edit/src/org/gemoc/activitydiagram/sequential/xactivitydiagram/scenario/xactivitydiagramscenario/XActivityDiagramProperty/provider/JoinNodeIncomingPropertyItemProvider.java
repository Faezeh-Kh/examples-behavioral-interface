...
import org.gemoc.activitydiagram.sequential.xactivitydiagram.scenario.xactivitydiagramscenario.XActivityDiagramProperty.JoinNodeIncomingProperty;
...
/**
 * This is the item provider adapter for a {@link org.gemoc.activitydiagram.sequential.xactivitydiagram.scenario.xactivitydiagramscenario.XActivityDiagramProperty.JoinNodeIncomingProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JoinNodeIncomingPropertyItemProvider extends JoinNodePropertyItemProvider {
	/**
	 ...
	 * @generated
	 */
	public JoinNodeIncomingPropertyItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns JoinNodeIncomingProperty.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JoinNodeIncomingProperty"));
	}
	...
	public String getText(Object object) {
		Quantifier labelValue = ((JoinNodeIncomingProperty)object).getQuantifier();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_JoinNodeIncomingProperty_type") :
			getString("_UI_JoinNodeIncomingProperty_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(JoinNodeIncomingProperty.class)) {
			case XActivityDiagramPropertyPackage.JOIN_NODE_INCOMING_PROPERTY__QUANTIFIER:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case XActivityDiagramPropertyPackage.JOIN_NODE_INCOMING_PROPERTY__PROPERTY:
