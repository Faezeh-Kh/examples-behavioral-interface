...
public class WhileAdapter extends EObjectAdapter<While> implements org.gemoc.arduino.sequential.xarduinomt.arduino.While {
  ...
  public void setCondition(final Expression o) {
    if (o != null)
    	adaptee.setCondition(((org.gemoc.arduino.sequential.xarduino.adapters.xarduinomt.arduino.ExpressionAdapter) o).getAdaptee());
    else adaptee.setCondition(null);
  }
  
  @Override
  public void execute() {
    org.gemoc.arduino.sequential.xarduino.aspects.WhileAspect.execute(adaptee);
  }
