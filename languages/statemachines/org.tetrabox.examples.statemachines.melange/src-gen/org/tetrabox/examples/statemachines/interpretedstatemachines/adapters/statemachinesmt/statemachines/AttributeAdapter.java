...
public class AttributeAdapter extends EObjectAdapter<Attribute> implements statemachines.Attribute {
  ...
  public EClass eClass() {
    return statemachines.StatemachinesPackage.eINSTANCE.getAttribute();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case statemachines.StatemachinesPackage.ATTRIBUTE__NAME:
    		return getName();
    }
