 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.examples.statemachines.interpretedstatemachines.statemachines.almostuml.impl.StateMachineImpl#getRegions <em>Regions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateMachineImpl extends NamedElementImpl implements StateMachine {
	...
	public EList<Region> getRegions() {
		if (regions == null) {
			regions = new EObjectContainmentWithInverseEList<Region>(Region.class, this, AlmostumlPackage.STATE_MACHINE__REGIONS, AlmostumlPackage.REGION__STATE_MACHINE);
		}
		return regions;
	}
	 ...
	 * @generated
	 */
	public void eventOccurrenceReceived(CustomEvent eventType) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AlmostumlPackage.STATE_MACHINE__REGIONS:
