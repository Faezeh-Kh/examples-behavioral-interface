...
public class NamedElementAdapter extends EObjectAdapter<NamedElement> implements statemachines.almostuml.NamedElement {
  ...
  public EClass eClass() {
    return statemachines.almostuml.AlmostumlPackage.eINSTANCE.getNamedElement();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case statemachines.almostuml.AlmostumlPackage.NAMED_ELEMENT__NAME:
    		return getName();
    }
