		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivitydiagramPackage.Literals.BOOLEAN_VARIABLE__INITIAL_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addCurrentValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BooleanVariable_currentValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanVariable_currentValue_feature", "_UI_BooleanVariable_type"),
				 ActivitydiagramPackage.Literals.BOOLEAN_VARIABLE__CURRENT_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
