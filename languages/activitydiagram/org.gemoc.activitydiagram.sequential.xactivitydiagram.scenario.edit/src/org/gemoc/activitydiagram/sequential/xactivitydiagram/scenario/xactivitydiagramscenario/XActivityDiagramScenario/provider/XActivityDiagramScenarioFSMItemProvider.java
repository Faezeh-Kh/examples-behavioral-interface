...
/**
 * This is the item provider adapter for a {@link org.gemoc.activitydiagram.sequential.xactivitydiagram.scenario.xactivitydiagramscenario.XActivityDiagramScenario.XActivityDiagramScenarioFSM} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class XActivityDiagramScenarioFSMItemProvider extends ScenarioFSMItemProvider {
	/**
	 ...
	 * @generated
	 */
	public XActivityDiagramScenarioFSMItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns XActivityDiagramScenarioFSM.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/XActivityDiagramScenarioFSM"));
	}
	...
	public String getText(Object object) {
		String label = ((XActivityDiagramScenarioFSM)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_XActivityDiagramScenarioFSM_type") :
			getString("_UI_XActivityDiagramScenarioFSM_type") + " " + label;
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.SCENARIO_FSM__STATES,
				 XActivityDiagramScenarioFactory.eINSTANCE.createXActivityDiagramScenarioFSMState()));

		newChildDescriptors.add
			(createChildParameter
				(ScenarioPackage.Literals.SCENARIO_FSM__TRANSITIONS,
				 XActivityDiagramScenarioFactory.eINSTANCE.createXActivityDiagramScenarioFSMTransition()));
	}
