...
import org.gemoc.activitydiagram.sequential.xactivitydiagram.scenario.xactivitydiagramscenario.XActivityDiagramProperty.UnaryOpaqueActionProperty;
...
/**
 * This is the item provider adapter for a {@link org.gemoc.activitydiagram.sequential.xactivitydiagram.scenario.xactivitydiagramscenario.XActivityDiagramProperty.UnaryOpaqueActionProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryOpaqueActionPropertyItemProvider extends OpaqueActionPropertyItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UnaryOpaqueActionPropertyItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns UnaryOpaqueActionProperty.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UnaryOpaqueActionProperty"));
	}
	...
	public String getText(Object object) {
		UnaryOperator labelValue = ((UnaryOpaqueActionProperty)object).getOperator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_UnaryOpaqueActionProperty_type") :
			getString("_UI_UnaryOpaqueActionProperty_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UnaryOpaqueActionProperty.class)) {
			case XActivityDiagramPropertyPackage.UNARY_OPAQUE_ACTION_PROPERTY__OPERATOR:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case XActivityDiagramPropertyPackage.UNARY_OPAQUE_ACTION_PROPERTY__PROPERTY:
