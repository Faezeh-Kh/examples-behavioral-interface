...
public class DelayAspect extends InstructionAspect {
  @Step
  @OverrideAspectMethod
  public static void execute(final Delay _self) {
	final org.gemoc.arduino.sequential.xarduino.aspects.DelayAspectDelayAspectProperties _self_ = org.gemoc.arduino.sequential.xarduino.aspects.DelayAspectDelayAspectContext
			.getSelf(_self);
  ...
  protected static void _privk3_execute(final DelayAspectDelayAspectProperties _self_, final Delay _self) {
    try {
