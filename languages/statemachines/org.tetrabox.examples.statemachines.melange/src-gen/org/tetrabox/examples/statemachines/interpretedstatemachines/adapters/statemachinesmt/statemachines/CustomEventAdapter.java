...
public class CustomEventAdapter extends EObjectAdapter<CustomEvent> implements statemachines.CustomEvent {
  ...
  public EClass eClass() {
    return statemachines.StatemachinesPackage.eINSTANCE.getCustomEvent();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case statemachines.StatemachinesPackage.CUSTOM_EVENT__NAME:
    		return getName();
    }
