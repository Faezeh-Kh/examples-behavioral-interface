...
public class VertexAdapter extends EObjectAdapter<Vertex> implements statemachines.almostuml.Vertex {
  ...
  public EClass eClass() {
    return statemachines.almostuml.AlmostumlPackage.eINSTANCE.getVertex();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case statemachines.almostuml.AlmostumlPackage.VERTEX__NAME:
    		return getName();
    	case statemachines.almostuml.AlmostumlPackage.VERTEX__CONTAINER:
    		return getContainer();
    	case statemachines.almostuml.AlmostumlPackage.VERTEX__OUTGOING_TRANSITIONS:
    		return getOutgoingTransitions();
    	case statemachines.almostuml.AlmostumlPackage.VERTEX__INCOMING_TRANSITIONS:
