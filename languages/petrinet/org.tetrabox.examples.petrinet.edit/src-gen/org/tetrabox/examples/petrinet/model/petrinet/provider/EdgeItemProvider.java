...
/**
 * This is the item provider adapter for a {@link org.tetrabox.examples.petrinet.model.petrinet.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider extends NamedElementItemProvider {
	...
	protected void addPlacePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Edge_place_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Edge_place_feature", "_UI_Edge_type"),
						PetrinetPackage.Literals.EDGE__PLACE, true, false, true, null, null, null));
	}
	...
	protected void addTransitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Edge_transition_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Edge_transition_feature", "_UI_Edge_type"),
						PetrinetPackage.Literals.EDGE__TRANSITION, true, false, true, null, null, null));
	}
