...
public class BinaryExpressionAdapter extends EObjectAdapter<BinaryExpression> implements org.gemoc.arduino.sequential.xarduinomt.arduino.BinaryExpression {
  ...
  public BinaryOperatorKind getOperator() {
    return org.gemoc.arduino.sequential.xarduinomt.arduino.BinaryOperatorKind.get(adaptee.getOperator().getValue());
  }
  
  @Override
  public void setOperator(final BinaryOperatorKind o) {
    adaptee.setOperator(org.gemoc.arduino.sequential.xarduino.arduino.BinaryOperatorKind.get(o.getValue()));
  }
  ...
  public Integer evaluate() {
    return org.gemoc.arduino.sequential.xarduino.aspects.BinaryExpressionAspect.evaluate(adaptee);
  }
  
  protected final static BinaryOperatorKind OPERATOR_EDEFAULT = org.gemoc.arduino.sequential.xarduinomt.arduino.BinaryOperatorKind.SUB;
  ...
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.arduino.sequential.xarduinomt.arduino.ArduinoPackage.BINARY_EXPRESSION__OPERATOR:
    		return getOperator();
  ...
  public void eSet(final int featureID, final Object newValue) {
    switch (featureID) {
    	case org.gemoc.arduino.sequential.xarduinomt.arduino.ArduinoPackage.BINARY_EXPRESSION__OPERATOR:
    		setOperator(
    		(org.gemoc.arduino.sequential.xarduinomt.arduino.BinaryOperatorKind)
    		 newValue);
    		return;
    	case org.gemoc.arduino.sequential.xarduinomt.arduino.ArduinoPackage.BINARY_EXPRESSION__LEFT:
    		setLeft(
