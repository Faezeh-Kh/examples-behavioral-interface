...
public class ActivityNodeAspect extends NamedElementAspect {
  ...
  public static void execute(final ActivityNode _self) {
	...
	} else if (_self instanceof org.gemoc.activitydiagram.sequential.xactivitydiagram.activitydiagram.AcceptEventAction) {
		org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.AcceptEventActionAspect.execute(
				(org.gemoc.activitydiagram.sequential.xactivitydiagram.activitydiagram.AcceptEventAction) _self);
  ...
  public static boolean canAddToken(final ActivityNode _self, final ControlToken token) {
	final org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.ActivityNodeAspectActivityNodeAspectProperties _self_ = org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.ActivityNodeAspectActivityNodeAspectContext
			.getSelf(_self);
	Object result = null;
	result = _privk3_canAddToken(_self_, _self, token);
	;
	return (boolean) result;
}
  ...
  public static boolean hasOffers(final ActivityNode _self) {
	...
	if (_self instanceof org.gemoc.activitydiagram.sequential.xactivitydiagram.activitydiagram.DecisionNode) {
		...
		result = org.gemoc.activitydiagram.sequential.xactivitydiagram.aspects.AcceptEventActionAspect.hasOffers(
				(org.gemoc.activitydiagram.sequential.xactivitydiagram.activitydiagram.AcceptEventAction) _self);
	} else if (_self instanceof org.gemoc.activitydiagram.sequential.xactivitydiagram.activitydiagram.JoinNode) {
  ...
  protected static boolean _privk3_canAddToken(final ActivityNodeAspectActivityNodeAspectProperties _self_, final ActivityNode _self, final ControlToken token) {
    return true;
  }
