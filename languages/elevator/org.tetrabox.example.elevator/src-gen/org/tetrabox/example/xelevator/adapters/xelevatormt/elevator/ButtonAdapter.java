...
public class ButtonAdapter extends EObjectAdapter<Button> implements org.tetrabox.example.xelevatormt.elevator.Button {
  ...
  public EClass eClass() {
    return org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.eINSTANCE.getButton();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.BUTTON__REQUESTED_FLOOR:
    		return getRequestedFloor();
    	case org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.BUTTON__PRESSED:
