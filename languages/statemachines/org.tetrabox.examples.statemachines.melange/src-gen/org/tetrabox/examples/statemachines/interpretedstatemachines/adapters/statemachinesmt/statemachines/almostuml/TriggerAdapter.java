...
public class TriggerAdapter extends EObjectAdapter<Trigger> implements statemachines.almostuml.Trigger {
  ...
  public void setEvent(final Event o) {
    if (o != null)
    	adaptee.setEvent(((org.tetrabox.examples.statemachines.interpretedstatemachines.adapters.statemachinesmt.statemachines.almostuml.EventAdapter) o).getAdaptee());
  ...
  public EClass eClass() {
    return statemachines.almostuml.AlmostumlPackage.eINSTANCE.getTrigger();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case statemachines.almostuml.AlmostumlPackage.TRIGGER__NAME:
    		return getName();
    	case statemachines.almostuml.AlmostumlPackage.TRIGGER__EVENT:
    		return getEvent();
    }
