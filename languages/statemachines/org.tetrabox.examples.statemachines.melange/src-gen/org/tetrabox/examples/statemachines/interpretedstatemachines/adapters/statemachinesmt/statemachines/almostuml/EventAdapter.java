...
public class EventAdapter extends EObjectAdapter<Event> implements statemachines.almostuml.Event {
  ...
  public EClass eClass() {
    return statemachines.almostuml.AlmostumlPackage.eINSTANCE.getEvent();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case statemachines.almostuml.AlmostumlPackage.EVENT__NAME:
    		return getName();
    }
