...
public class ElevatorButtonAdapter extends EObjectAdapter<ElevatorButton> implements org.tetrabox.example.xelevatormt.elevator.ElevatorButton {
  private XElevatorMTAdaptersFactory adaptersFactory;
  
  public ElevatorButtonAdapter() {
  ...
  public EClass eClass() {
    return org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.eINSTANCE.getElevatorButton();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.ELEVATOR_BUTTON__REQUESTED_FLOOR:
    		return getRequestedFloor();
    	case org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.ELEVATOR_BUTTON__PRESSED:
