...
public class DownButtonAdapter extends EObjectAdapter<DownButton> implements org.tetrabox.example.xelevatormt.elevator.DownButton {
  private XElevatorMTAdaptersFactory adaptersFactory;
  
  public DownButtonAdapter() {
  ...
  public EClass eClass() {
    return org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.eINSTANCE.getDownButton();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.DOWN_BUTTON__REQUESTED_FLOOR:
    		return getRequestedFloor();
    	case org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.DOWN_BUTTON__PRESSED:
