		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JoinNode_incoming_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JoinNode_incoming_feature", "_UI_JoinNode_type"),
				 ActivitydiagramPackage.Literals.JOIN_NODE__INCOMING,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutgoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JoinNode_outgoing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JoinNode_outgoing_feature", "_UI_JoinNode_type"),
				 ActivitydiagramPackage.Literals.JOIN_NODE__OUTGOING,
				 true,
				 false,
				 true,
				 null,
