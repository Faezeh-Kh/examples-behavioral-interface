...
public class IntegerAttributeAdapter extends EObjectAdapter<IntegerAttribute> implements statemachines.IntegerAttribute {
  ...
  public EClass eClass() {
    return statemachines.StatemachinesPackage.eINSTANCE.getIntegerAttribute();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case statemachines.StatemachinesPackage.INTEGER_ATTRIBUTE__NAME:
    		return getName();
    }
