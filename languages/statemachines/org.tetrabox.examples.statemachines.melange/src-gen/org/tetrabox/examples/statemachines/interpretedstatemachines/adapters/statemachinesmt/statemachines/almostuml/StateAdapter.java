...
public class StateAdapter extends EObjectAdapter<State> implements statemachines.almostuml.State {
  ...
  public EClass eClass() {
    return statemachines.almostuml.AlmostumlPackage.eINSTANCE.getState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case statemachines.almostuml.AlmostumlPackage.STATE__NAME:
    		return getName();
    	case statemachines.almostuml.AlmostumlPackage.STATE__CONTAINER:
    		return getContainer();
    	case statemachines.almostuml.AlmostumlPackage.STATE__OUTGOING_TRANSITIONS:
    		return getOutgoingTransitions();
    	case statemachines.almostuml.AlmostumlPackage.STATE__INCOMING_TRANSITIONS:
    		return getIncomingTransitions();
    	case statemachines.almostuml.AlmostumlPackage.STATE__REGIONS:
    		return getRegions();
    	case statemachines.almostuml.AlmostumlPackage.STATE__ENTRY:
    		return getEntry();
    	case statemachines.almostuml.AlmostumlPackage.STATE__DO_ACTIVITY:
    		return getDoActivity();
    	case statemachines.almostuml.AlmostumlPackage.STATE__EXIT:
    		return getExit();
    }
