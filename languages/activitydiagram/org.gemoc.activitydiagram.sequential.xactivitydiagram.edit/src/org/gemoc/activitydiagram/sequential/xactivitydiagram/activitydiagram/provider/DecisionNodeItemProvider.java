		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DecisionNode_incoming_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DecisionNode_incoming_feature", "_UI_DecisionNode_type"),
				 ActivitydiagramPackage.Literals.DECISION_NODE__INCOMING,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutgoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DecisionNode_outgoing_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DecisionNode_outgoing_feature", "_UI_DecisionNode_type"),
				 ActivitydiagramPackage.Literals.DECISION_NODE__OUTGOING,
				 true,
				 false,
				 true,
				 null,
