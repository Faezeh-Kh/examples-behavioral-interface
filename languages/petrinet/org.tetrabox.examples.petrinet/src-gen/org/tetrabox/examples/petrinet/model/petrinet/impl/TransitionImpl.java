 ...
 * </p>
 * <ul>
 *   <li>{@link org.tetrabox.examples.petrinet.model.petrinet.impl.TransitionImpl#getEdges <em>Edges</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends NamedElementImpl implements Transition {
	...
	public EList<Edge> getEdges() {
		if (edges == null) {
			edges = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, PetrinetPackage.TRANSITION__EDGES,
					PetrinetPackage.EDGE__TRANSITION);
		}
		return edges;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PetrinetPackage.TRANSITION__EDGES:
