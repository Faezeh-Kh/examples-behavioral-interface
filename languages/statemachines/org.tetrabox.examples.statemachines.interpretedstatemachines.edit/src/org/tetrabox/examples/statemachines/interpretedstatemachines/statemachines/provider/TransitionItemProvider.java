...
/**
 * This is the item provider adapter for a {@link org.tetrabox.examples.statemachines.interpretedstatemachines.statemachines.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatemachinesPackage.Literals.TRANSITION__KIND,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatemachinesPackage.Literals.TRANSITION__TRIGGERS);
			childrenFeatures.add(StatemachinesPackage.Literals.TRANSITION__EFFECT);
			childrenFeatures.add(StatemachinesPackage.Literals.TRANSITION__CONSTRAINT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StatemachinesPackage.Literals.TRANSITION__TRIGGERS,
				 StatemachinesFactory.eINSTANCE.createTrigger()));

		newChildDescriptors.add
			(createChildParameter
				(StatemachinesPackage.Literals.TRANSITION__EFFECT,
		...
		newChildDescriptors.add
			(createChildParameter
				(StatemachinesPackage.Literals.TRANSITION__CONSTRAINT,
				 StatemachinesFactory.eINSTANCE.createBooleanConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(StatemachinesPackage.Literals.TRANSITION__CONSTRAINT,
				 StatemachinesFactory.eINSTANCE.createIntegerConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(StatemachinesPackage.Literals.TRANSITION__CONSTRAINT,
				 StatemachinesFactory.eINSTANCE.createStringConstraint()));
	}
