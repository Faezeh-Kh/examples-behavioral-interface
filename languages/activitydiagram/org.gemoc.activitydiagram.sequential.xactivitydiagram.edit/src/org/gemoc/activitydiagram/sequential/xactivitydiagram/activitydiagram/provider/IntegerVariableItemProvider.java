		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ActivitydiagramPackage.Literals.INTEGER_VARIABLE__INITIAL_VALUE,
				 true,
				 false,
				 false,
	...
	protected void addCurrentValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IntegerVariable_currentValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerVariable_currentValue_feature", "_UI_IntegerVariable_type"),
				 ActivitydiagramPackage.Literals.INTEGER_VARIABLE__CURRENT_VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
