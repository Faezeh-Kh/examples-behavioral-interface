...
public class FloorButtonAdapter extends EObjectAdapter<FloorButton> implements org.tetrabox.example.xelevatormt.elevator.FloorButton {
  private XElevatorMTAdaptersFactory adaptersFactory;
  
  public FloorButtonAdapter() {
  ...
  public EClass eClass() {
    return org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.eINSTANCE.getFloorButton();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.FLOOR_BUTTON__REQUESTED_FLOOR:
    		return getRequestedFloor();
    	case org.tetrabox.example.xelevatormt.elevator.ElevatorPackage.FLOOR_BUTTON__PRESSED:
