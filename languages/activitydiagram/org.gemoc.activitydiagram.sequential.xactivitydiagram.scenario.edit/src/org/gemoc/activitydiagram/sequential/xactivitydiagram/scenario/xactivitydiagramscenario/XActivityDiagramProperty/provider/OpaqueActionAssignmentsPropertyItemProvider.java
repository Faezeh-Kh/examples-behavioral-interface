...
import org.gemoc.activitydiagram.sequential.xactivitydiagram.scenario.xactivitydiagramscenario.XActivityDiagramProperty.OpaqueActionAssignmentsProperty;
...
/**
 * This is the item provider adapter for a {@link org.gemoc.activitydiagram.sequential.xactivitydiagram.scenario.xactivitydiagramscenario.XActivityDiagramProperty.OpaqueActionAssignmentsProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OpaqueActionAssignmentsPropertyItemProvider extends OpaqueActionPropertyItemProvider {
	/**
	 ...
	 * @generated
	 */
	public OpaqueActionAssignmentsPropertyItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns OpaqueActionAssignmentsProperty.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OpaqueActionAssignmentsProperty"));
	}
	...
	public String getText(Object object) {
		Quantifier labelValue = ((OpaqueActionAssignmentsProperty)object).getQuantifier();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_OpaqueActionAssignmentsProperty_type") :
			getString("_UI_OpaqueActionAssignmentsProperty_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OpaqueActionAssignmentsProperty.class)) {
			case XActivityDiagramPropertyPackage.OPAQUE_ACTION_ASSIGNMENTS_PROPERTY__QUANTIFIER:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case XActivityDiagramPropertyPackage.OPAQUE_ACTION_ASSIGNMENTS_PROPERTY__PROPERTY:
