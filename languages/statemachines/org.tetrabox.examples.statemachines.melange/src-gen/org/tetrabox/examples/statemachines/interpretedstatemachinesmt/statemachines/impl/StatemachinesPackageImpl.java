...
import org.tetrabox.examples.statemachines.interpretedstatemachinesmt.statemachines.NamedElement;
...
public class StatemachinesPackageImpl extends EPackageImpl implements StatemachinesPackage {
	...
	public void initializePackageContents() {
		...
		addEParameter(op, this.getEventOccurrence(), "event", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEParameter(op, this.getEventOccurrence(), "eventOccurrence", 0, 1, IS_UNIQUE, IS_ORDERED);
