...
public class StateMachineAdapter extends EObjectAdapter<StateMachine> implements org.tetrabox.examples.statemachines.interpretedstatemachinesmt.statemachines.almostuml.StateMachine {
  ...
  @Override
  public void eventOccurrenceReceived(final CustomEvent eventType) {
    org.tetrabox.examples.statemachines.interpretedstatemachines.aspects.StateMachineAspect.eventOccurrenceReceived(adaptee, (org.tetrabox.examples.statemachines.interpretedstatemachines.statemachines.CustomEvent)((EObjectAdapter)eventType).getAdaptee()
    );
  }
  ...
  public EClass eClass() {
    return org.tetrabox.examples.statemachines.interpretedstatemachinesmt.statemachines.almostuml.AlmostumlPackage.eINSTANCE.getStateMachine();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.tetrabox.examples.statemachines.interpretedstatemachinesmt.statemachines.almostuml.AlmostumlPackage.STATE_MACHINE__NAME:
    		return getName();
    	case org.tetrabox.examples.statemachines.interpretedstatemachinesmt.statemachines.almostuml.AlmostumlPackage.STATE_MACHINE__REGIONS:
    		return getRegions();
    }
