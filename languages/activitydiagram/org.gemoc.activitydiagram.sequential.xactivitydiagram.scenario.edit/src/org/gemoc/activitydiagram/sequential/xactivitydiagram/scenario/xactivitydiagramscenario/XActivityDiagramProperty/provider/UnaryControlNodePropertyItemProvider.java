...
import org.gemoc.activitydiagram.sequential.xactivitydiagram.scenario.xactivitydiagramscenario.XActivityDiagramProperty.UnaryControlNodeProperty;
...
/**
 * This is the item provider adapter for a {@link org.gemoc.activitydiagram.sequential.xactivitydiagram.scenario.xactivitydiagramscenario.XActivityDiagramProperty.UnaryControlNodeProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryControlNodePropertyItemProvider extends ControlNodePropertyItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UnaryControlNodePropertyItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns UnaryControlNodeProperty.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UnaryControlNodeProperty"));
	}
	...
	public String getText(Object object) {
		UnaryOperator labelValue = ((UnaryControlNodeProperty)object).getOperator();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_UnaryControlNodeProperty_type") :
			getString("_UI_UnaryControlNodeProperty_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UnaryControlNodeProperty.class)) {
			case XActivityDiagramPropertyPackage.UNARY_CONTROL_NODE_PROPERTY__OPERATOR:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case XActivityDiagramPropertyPackage.UNARY_CONTROL_NODE_PROPERTY__PROPERTY:
