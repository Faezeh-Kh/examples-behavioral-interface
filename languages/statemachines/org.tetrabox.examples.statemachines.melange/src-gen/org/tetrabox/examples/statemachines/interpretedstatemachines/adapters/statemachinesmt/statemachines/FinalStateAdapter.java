...
public class FinalStateAdapter extends EObjectAdapter<FinalState> implements statemachines.FinalState {
  ...
  public EClass eClass() {
    return statemachines.StatemachinesPackage.eINSTANCE.getFinalState();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case statemachines.StatemachinesPackage.FINAL_STATE__NAME:
    		return getName();
    	case statemachines.StatemachinesPackage.FINAL_STATE__CONTAINER:
    		return getContainer();
    	case statemachines.StatemachinesPackage.FINAL_STATE__OUTGOING_TRANSITIONS:
    		return getOutgoingTransitions();
    	case statemachines.StatemachinesPackage.FINAL_STATE__INCOMING_TRANSITIONS:
    		return getIncomingTransitions();
    	case statemachines.StatemachinesPackage.FINAL_STATE__REGIONS:
    		return getRegions();
    	case statemachines.StatemachinesPackage.FINAL_STATE__ENTRY:
    		return getEntry();
    	case statemachines.StatemachinesPackage.FINAL_STATE__DO_ACTIVITY:
    		return getDoActivity();
    	case statemachines.StatemachinesPackage.FINAL_STATE__EXIT:
    		return getExit();
    	case statemachines.StatemachinesPackage.FINAL_STATE__DEFERRABLE_TRIGGERS:
    		return getDeferrableTriggers();
    	case statemachines.StatemachinesPackage.FINAL_STATE__CONNECTION_POINT:
