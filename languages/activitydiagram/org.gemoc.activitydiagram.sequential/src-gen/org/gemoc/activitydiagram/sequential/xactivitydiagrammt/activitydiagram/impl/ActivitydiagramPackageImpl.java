...
public class ActivitydiagramPackageImpl extends EPackageImpl implements ActivitydiagramPackage {
	 ...
	 * @generated
	 */
	public EReference getAcceptEventAction_EventType() {
	 ...
	 * @generated
	 */
	public EReference getAcceptEventAction_Incoming() {
	 ...
	 * @generated
	 */
	public EReference getAcceptEventAction_Outgoing() {
	...
	public void createPackageContents() {
		...
		createEReference(acceptEventActionEClass, ACCEPT_EVENT_ACTION__EVENT_TYPE);
		createEReference(acceptEventActionEClass, ACCEPT_EVENT_ACTION__INCOMING);
		createEReference(acceptEventActionEClass, ACCEPT_EVENT_ACTION__OUTGOING);
	...
	public void initializePackageContents() {
		...
		acceptEventActionEClass.getESuperTypes().add(this.getActivityNode());
		...
		initEReference(getActivity_Events(), this.getEvent(), null, "events", null, 0, -1, Activity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = addEOperation(activityNodeEClass, ecorePackage.getEBoolean(), "canAddToken", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getControlToken(), "token", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getAcceptEventAction_EventType(), this.getEvent(), null, "eventType", null, 1, 1, AcceptEventAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAcceptEventAction_Incoming(), this.getActivityEdge(), null, "incoming", null, 0, 1, AcceptEventAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getAcceptEventAction_Outgoing(), this.getActivityEdge(), null, "outgoing", null, 1, 1, AcceptEventAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = addEOperation(acceptEventActionEClass, null, "sendOffer", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getControlToken(), "token", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(acceptEventActionEClass, ecorePackage.getEBoolean(), "canAccept", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getEvent(), "event", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(acceptEventActionEClass, null, "accept", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getEvent(), "event", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(acceptEventActionEClass, null, "waitForEvent", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(acceptEventActionEClass, null, "execute", 0, 1, IS_UNIQUE, IS_ORDERED);

		addEOperation(acceptEventActionEClass, ecorePackage.getEBoolean(), "hasOffers", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (acceptEventActionEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (acceptEventActionEClass.getEOperations().get(2), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (acceptEventActionEClass.getEOperations().get(3), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (acceptEventActionEClass.getEOperations().get(4), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (acceptEventActionEClass.getEOperations().get(5), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
